...
\section{Cifrado de Cesar}
	...
	Teniendo en cuenta que las letras más frecuentes en el español son la A y la E, identificamos que éstas se encuentran en la misma distancia entre sí que las letras V y Z en tanto en ambos casos hay 4 saltos. Por tanto se evalua que el texto fue cifrado con Cesar donde el número de saltos corresponde a 21, lo cual se logró comprobar al realizar la respectiva sustitución por cada letra.

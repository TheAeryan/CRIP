...
\section{Cifrado de Cesar}
	Luego, se descifraron los textos que se encontran cifrados con \textbf{Cifrado de Cesar} para lo cual se evaluaron las \textbf{frecuencias} de los textos. Así, evidenciamos que en el texto 1 la letra más frecuente es la V con 25.636 por cien, seguida de la letra Z con 7.872 y la letra Ñ con 6.848. 

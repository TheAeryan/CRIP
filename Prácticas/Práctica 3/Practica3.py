...
def factorizacion_fermat(n):
    ...
    while (True):
        ...
        if escuadrado(y):  # Si y es un cuadrado, ya he encontrado los divisores de n
            ...
            # Si son primos, los devuelvo. Si no, los vuelvo a factorizar recursivamente
            if not test_MillerRabin(factores[0],
                                    20):  # Uso el test de Miller-Rabin para comprobar primalidad con 20 testigos diferentes
...
lista20_primos = [23832700531121320493, 32067152828622175193, 64838294355389912957, 77731138202499790837,
                  33423477292403677723]
lista21_primos = [53600866259326776197, 22793570657777597263, 18074032185982204823, 33930605840215624663,
                  13601238120718019917]
lista22_primos = [1672199105076190147777, 2909110242661320153353, 4328742703764961215059, 3818893662431602043423,
                  806167066427286906967]
...
lista25_primos = [468005510558668309872259, 544238069390407160922089, 202666659583753040985703,
                  249812478106396177087649, 530320315648038911308949]
lista30_primos = [349918146876821449306418779589, 206602364307104253637740363733, 613006584758208824755166300473,
                  948179851363658864249921518783, 286495981162490897726704631897]
...
tiempos_fb_primos = [0.00019092559814453124, 0.0002642631530761719, 0.0002818107604980469, 0.0009270191192626953,
                     0.0008560657501220703, 0.003333568572998047, 0.25221872329711914, 1.613796329498291,
                     1.1491723537445069, 14.669361448287964, 16.867420434951782]
...
# 20 cifras
tiempos_fermat_primos = [0.0003816127777099609, 0.0009403228759765625, 0.0007202625274658203, 0.0013695716857910155,
                         0.0013250350952148438, 0.004761886596679687, 0.7187267303466797, 888.2101609230042]
...
# 28 cifras
tiempos_pollard_primos = [0.00038447380065917967, 0.0005166053771972657, 0.0005702972412109375, 0.0008878707885742188,
                          0.00022954940795898436, 0.0015295982360839845, 0.006908845901489258, 0.2487804889678955,
                          0.20681509971618653, 0.8142501831054687, 0.8326740741729737, 2.2809261322021483]
